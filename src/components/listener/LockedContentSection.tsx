  ...
  return (
    <section className="relative">
      ...
      <div className="relative">
        ...
        {/* Overlay */}
        <div className="absolute inset-0 bg-gradient-to-t from-[#121212] via-[#121212]/80 to-transparent flex flex-col items-center justify-end pb-8">
          <p className="text-white font-semibold mb-2">Subscribe to unlock</p>
          <p className="text-[#a7a7a7] text-sm mb-5 text-center px-5">
